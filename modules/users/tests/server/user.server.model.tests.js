...
//       var _user1 = new User(user1);
//       _user1.password = 'Open-Source Full-Stack Solution for birthday_app';
//       var passwordBeforeSave = _user1.password;
//       _user1.save(function (err) {
//         should.not.exist(err);
//         _user1.password.should.not.equal(passwordBeforeSave);
...
//     it('should validate when the passphrase strength passes - "Open-Source Full-Stack Solution For birthday_app Applications"', function () {
//       var _user1 = new User(user1);
//       _user1.password = 'Open-Source Full-Stack Solution For birthday_app Applications';
