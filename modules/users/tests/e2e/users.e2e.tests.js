...
//     firstName: 'test',
//     lastName: 'user',
//     email: 'test.user@birthday_app.com',
//     username: 'testUser',
//     password: 'P@$$w0rd!!'
//   };
...
//     firstName: 'test',
//     lastName: 'user2',
//     email: 'test.user2@birthday_app.com',
//     username: 'testUser2',
//     password: 'P@$$w0rd!!'
//   };
...
//       element(by.css('button[type=submit]')).click();
//       // Email address error
//       expect(element.all(by.css('.error-text')).get(0).getText()).toBe('Please enter your email address.');
//     });
...
//       // Enter Email
//       element(by.model('vm.credentials.email')).sendKeys('someemail@birthday_app.com');
//       // Enter Username
//       element(by.model('vm.credentials.username')).sendKeys('log.in');
//       // Enter Password
