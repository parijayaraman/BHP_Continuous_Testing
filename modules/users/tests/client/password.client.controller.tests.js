      ...
      describe('askForPasswordReset', function() {
        ...
        describe('POST error', function() {
          ...
          it('should call Notification.error with response message', function() {
            expect(Notification.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="glyphicon glyphicon-remove"></i> Failed to send password reset email!', delay: 10000 });
          });
        });

        describe('POST success', function() {
          var successMessage = 'An email is sent to the registered email with further instructions';
          beforeEach(function() {
