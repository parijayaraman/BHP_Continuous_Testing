...
//           expect(Notification.error).toHaveBeenCalledWith({ message: 'Missing credentials', title: '<i class="glyphicon glyphicon-remove"></i> Sign-in error!', delay: 6000 });
//         });
...
//           // Test Notification.error is called
//           expect(Notification.error).toHaveBeenCalledWith({ message: 'Unknown user', title: '<i class="glyphicon glyphicon-remove"></i> Sign-in error!', delay: 6000 });
//         });
//       });
...
//           // Test Notification.error is called
//           expect(Notification.error).toHaveBeenCalledWith({ message: 'Username already exists', title: '<i class="glyphicon glyphicon-remove"></i> Sign-Up Error!', delay: 6000 });
//         });
//       });
//     });
