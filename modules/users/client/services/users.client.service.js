  ...
  function UsersService($resource) {
    var Users = $resource('/api/users', {}, {
      ...
      updateDefaultTemplate: {
        method: 'PUT',
        url: '/api/users/updateDefaultTemplate'
      },
      updateDefaultReminder: {
        method: 'PUT',
        url: '/api/users/updateDefaultReminder'
      }
    });
    ...
    angular.extend(Users, {
      ...
      setDefaultTemplate: function (template) {
        return this.updateDefaultTemplate(template).$promise;
      },
      setDefaultReminder: function (reminder) {
        return this.updateDefaultReminder(reminder).$promise;
      }
    });
