...
module.exports = {
  app: {
    title: 'Birthday Headlines',
    description: 'Birthday application',
  ...
  sessionSecret: process.env.SESSION_SECRET || 'birthday_appSecret',
  ...
  illegalUsernames: ['birthday_app', 'administrator', 'password', 'admin', 'user',
